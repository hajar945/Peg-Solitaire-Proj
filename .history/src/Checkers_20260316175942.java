...
public class Checkers extends JPanel {
    ...
    private class Board extends JPanel implements ActionListener, MouseListener {
        ...
        public Dimension getPreferredSize() {
            // Safety check: if Swing asks for size before initialization is done, don't crash
            if (board == null) return new Dimension(300, 300);
            ...
            if (input != null) {
                try {
                    ...
                    if (newSize < 3 || newSize % 2 == 0) {
                        ...
                        // Abort any game currently in progress automatically
                        if (gameInProgress) {
                        ...
                        // Tell the window to shrink/grow to perfectly fit the new board!
       ...
       void doNewGame() {
            // We completely removed the check that forces you to finish the game first!
            ...
            // Keep the New Game button enabled at all times so you can reset whenever!
