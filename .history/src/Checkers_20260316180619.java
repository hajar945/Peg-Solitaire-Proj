...
public class Checkers extends JPanel {
    ...
    public Checkers() {
        ...
        // Switching to BoxLayout stops the buttons from stretching!
        ...
        // Align the buttons to the left edge of the panel
        newGameButton.setAlignmentX(Component.LEFT_ALIGNMENT);
        sizeButton.setAlignmentX(Component.LEFT_ALIGNMENT);

        buttonPanel.add(newGameButton);
        buttonPanel.add(Box.createRigidArea(new Dimension(0, 15))); // Adds a 15-pixel gap between buttons
